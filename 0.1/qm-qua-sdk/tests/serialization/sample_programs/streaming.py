...
with program() as prog:
    ...
    with stream_processing():
        ...
        stream.average().map(FUNCTIONS.average([0])).save("avgl0")
        stream.average().map(FUNCTIONS.average([1])).save("avgl1")
        stream.average().map(FUNCTIONS.average([0, 1])).save("avgl01")
