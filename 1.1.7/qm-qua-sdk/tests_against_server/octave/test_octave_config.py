...
def qmm_with_octave(host_port, monkeypatch) -> QuantumMachinesManager:
    ...
    return QuantumMachinesManager(**host_port, octave=octave_config, connection_headers={"some_key": "some_value"})
...
def test_octave_config_loop_backs(
    ...
    headers = {"some_key": "some_value", SERVICE_HEADER_NAME: "oct1",
                            'cluster_name': 'any', 'any_cluster': 'true'}
    token = qmm_with_octave._user_config.user_token
    if token:
