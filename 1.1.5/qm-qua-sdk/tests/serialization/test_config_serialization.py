...
def test_simple_config():
    ...
    valid_config = {
        "version": "1",
        "elements": {
            "el1": {"singleInput": {"port": ("con1", 1)}, "oscillator": "osc"}
        },
        "integration_weights": {
...
def test_config_with_apo_in_name():
    ...
    valid_config = {
        "version": "1",
        "elements": {
            "element'": {"singleInput": {"port": ("con1", 1)}, "oscillator": "osc"}
        },
        "integration_weights": {
            "long_integW1": {"cosine": [1.0] * 50, "sine": [0.0] * 50},
        },
        ...
        "mixers": {
            ...
            "transmon_mixer": [
                ...
                },
                {
                    ...
                    "intermediate_frequency": 214126117,
                    "lo_frequency": 4200000000
                },
                {
                    "correction": [
                ...
                },
                {
                    ...
                    "intermediate_frequency": 74294668,
                    "lo_frequency": 4200000000
                }
            ]
        },
